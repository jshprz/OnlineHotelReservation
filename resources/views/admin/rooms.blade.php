...
<tr>
<td><center>{{$rooms->id}}</td>
<td><center>{{$rooms->room_number}}</td>
<td><center>{{$rooms->room_type}}</td>
<td><center>{{$rooms->status}}</td>
<td><center>{{$rooms->price}}</td>
<td>
<button data-toggle="modal" data-target="#update-item-{{$rooms->id}}" class='edit-modal btn btn-warning'>
Edit
</button>
</td>
</tr>
  ...
  <div>
		<div class="modal fade" id="update-item-{{$rooms->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <input type="number" name="room_number" class="form-control" value="{{number_format($rooms->room_number)}}"/>
    </div>
     <div class="form-group">
    <label for="price">ROOM TYPE:</label>
    <input type="text" name="room_type" class="form-control" value="{{$rooms->room_type}}"/>
    </div>
    <div class="form-group">
        <label for="price">STATUS:</label>
        <input type="text" name="status" class="form-control" value="{{$rooms->status}}"/>
    </div>
    <div class="form-group">
        <label for="price">PRICE:</label>
        <input type="number" name="price" class="form-control" value="{{number_format($rooms->price)}}"/>
    </div>
    <input type="text" name="id" class="form-control hidden" value="{{$rooms->id}}"/>
    <div class="form-group">
